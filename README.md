...
- Escolha e personalização de perfil com dados acadêmicos (nome, e-mail, RA, curso, foto).  
- Sistema de pedidos e agendamento de refeições, integrado a notificações.  
- Redefinição de senha e fluxo de recuperação via e-mail.  

Nosso objetivo é **digitalizar a experiência da cantina**, tornando-a prática, rápida e intuitiva para os alunos.  
...
- [Node.js](https://nodejs.org/) (para frontend web)  
...
✍️ Desenvolvido com dedicação pelo grupo **CT Dev's**.